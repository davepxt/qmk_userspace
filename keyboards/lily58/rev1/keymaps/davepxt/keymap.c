...
[1] = LAYOUT(
  ...
  KC_NO , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO  , KC_NO  ,     KC_NO , KC_INS  , KC_END  , KC_PGDN , KC_PGUP , KC_HOME , KC_NO,
                              KC_NO   , KC_ESC  , KC_SPC , KC_TAB ,     KC_NO , KC_NO   , KC_NO   , KC_NO
),
...
[4] = LAYOUT(
  ...
  KC_LALT , KC_Z  , KC_X  , KC_C  , KC_V    , KC_B   , KC_NO  ,     KC_NO  , KC_N    , KC_M  , KC_COMM , KC_DOT , KC_SLSH , KC_RALT,
                            KC_NO , KC_TRNS , KC_SPC , KC_TAB ,     KC_ENT , KC_BSPC , DF(0) , KC_NO
)
};
